...
<head>
    ...
    <link href="{{ url('/frontend/assets/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') }}"
        rel="stylesheet" />
...
<body>
    ...
    {{-- multiple select cdn --}}
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.I.I/js/bootstrap.bundle.in.js">
        < script > < script src =
            "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/l.13.I/js/bootstrap-select.min.js" >
    </script>
